...
public class Main {
    public static void main(String[] args) {
        ...
        Room reservationRoom1 = new Booking(1, LocalDate.of(2021,7,19), LocalDate.of(2021,7,26));

        room1.addGuest(adelaMalikova);

        Room reservationRoom3 = new Booking(3, LocalDate.of(2021,9,1), LocalDate.of(2021,9,14));
